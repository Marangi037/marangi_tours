  ...
  return (
    <section id='testimonials' className='min-w-screen min-h-[80vh] flex justify-center items-center overflow-hidden relative py-[2rem] lg:py-0 bg-white'>
            ...
            <div className='bg-gray-400 w-[70%] lg:w-[50vw] h-[45vh] lg:h-[60vh] border-2 border-transparent rounded-2xl pb-5 flex flex-col gap-6 overflow-hidden my-4'>
              ...
              <p className='text-start text-[14px] lg:text-3xl mx-[4rem] relative'><span className='absolute top-[-1.5rem] left-[-1.5rem] text-5xl text-yellow-300 font-bold'>“</span>{testimonials[currentIndex].desc} <span className='absolute top-[-1.5rem] lg:right-[2rem] right-[-1rem] text-5xl text-yellow-300 font-bold'>”</span></p>
              <div className='w-full h-max flex flex-col gap-2'>
                <h1 className='lg:text-3xl text-2xl pl-18'>{testimonials[currentIndex].name}</h1>
        ...
        <div className="absolute w-full lg:min-w-[80%] h-[20px] flex justify-between top-1/2 px-4 lg:px-8">
