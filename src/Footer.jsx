  ...
  return (
    <section className='max-w-screen h-screen lg:h-[60vh] p-[3rem]  lg:flex gap-6 bg-black text-white grid grid-cols-2'>
        ...
        <div className='w-1/2 lg:w-1/5 flex flex-col gap-4 justify-start items-center'>
          <h1 className='text-2xl lg:text-4xl text-nowrap'>our offices</h1>
        ...
        <div className='flex flex-col w-[100vw] lg:w-1/5 gap-4 lg:justify-start justify-center items-center px-2'>
          ...
          <div className='flex gap-2'>
            <input className='w-[100px] lg:w-[150px] h-[40px] rounded-md outline-0 bg-gray-300 px-2 text-black' type="text" placeholder='enter your email'/>
