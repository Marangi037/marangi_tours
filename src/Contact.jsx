...
export const Contact = () => {
  return (
    <section className='max-w-screen min-w-screen h-screen flex flex-col bg-[url("/call_bg.jpg")] bg-center bg-no-repeat bg-cover justify-between items-center text-white bg-white' id='contact'>
        <div className='w-full h-full backdrop-blur-[5px] gap-[2rem] flex flex-col'>
            ...
            <div className='h-[90%] flex flex-col lg:flex-row w-[70%] justify-center items-center lg:w-full'>
                <div className=' w-full lg:w-1/2 h-[80%] flex flex-col px-4 lg:px-[12rem] gap-5 pt-[4rem] text-black lg:text-white justify-start items-start'>
                    <div className='w-full h-max flex justify-between items-center gap-4'>
                        <div className='w-1/2 h-max flex flex-col items-start justify-center'>
                            <label className='text-2xl text-nowrap' htmlFor="input">First name</label>
                ...
                <div className='w-full lg:w-1/2 h-[80%] flex flex-col px-4 lg:px-[12rem] justify-center items-start gap-5 pb-[5rem] text-white'>
                    ...
                    <h1 className='text-2xl lg:text-3xl'>or you can visit our various offices across the country</h1>
